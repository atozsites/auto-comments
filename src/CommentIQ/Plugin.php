...
class CommentIQ_Plugin
{
    ...
    /**
     * Get the atozsites comment generator.
     *
     * @return CommentIQ_Generator_atozsitesCommentGenerator
     */
    private function get_atozsites_comment_generator()
    {
    ...
    {
        return array(
            new CommentIQ_Shortcode_atozsitesCommentShortcode($this->get_atozsites_comment_generator(), $this->get_supported_post_types()),
        );
    }
